SERVICE = electronicannotationmethods
SERVICE_CAPS = ElectronicAnnotationMethods
SPEC_FILE = ElectronicAnnotationMethods.spec
URL = https://kbase.us/services/electronicannotationmethods
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
