...
class ElectronicAnnotationMethods(object):
    ...
    def remap_annotations_with_interpro2go(self, params, json_rpc_context = None):
        if json_rpc_context and type(json_rpc_context) is not dict:
            raise ValueError('Method remap_annotations_with_interpro2go: argument json_rpc_context is not type dict as required.')
        resp = self._call('ElectronicAnnotationMethods.remap_annotations_with_interpro2go',
                          [params], json_rpc_context)
        return resp[0]
  
    def remap_annotations_with_ec2go(self, params, json_rpc_context = None):
        if json_rpc_context and type(json_rpc_context) is not dict:
            raise ValueError('Method remap_annotations_with_ec2go: argument json_rpc_context is not type dict as required.')
        resp = self._call('ElectronicAnnotationMethods.remap_annotations_with_ec2go',
                          [params], json_rpc_context)
        return resp[0]
  
    def remap_annotations_with_uniprotkb_keyword2go(self, params, json_rpc_context = None):
        if json_rpc_context and type(json_rpc_context) is not dict:
            raise ValueError('Method remap_annotations_with_uniprotkb_keyword2go: argument json_rpc_context is not type dict as required.')
        resp = self._call('ElectronicAnnotationMethods.remap_annotations_with_uniprotkb_keyword2go',
                          [params], json_rpc_context)
        return resp[0]
