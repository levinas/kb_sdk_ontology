...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'ElectronicAnnotationMethods'):
...
impl_ElectronicAnnotationMethods = ElectronicAnnotationMethods(config)
...
async_run_methods = {}
async_check_methods = {}
async_run_methods['ElectronicAnnotationMethods.remap_annotations_with_interpro2go_async'] = ['ElectronicAnnotationMethods', 'remap_annotations_with_interpro2go']
async_check_methods['ElectronicAnnotationMethods.remap_annotations_with_interpro2go_check'] = ['ElectronicAnnotationMethods', 'remap_annotations_with_interpro2go']
sync_methods['ElectronicAnnotationMethods.remap_annotations_with_interpro2go'] = True
async_run_methods['ElectronicAnnotationMethods.remap_annotations_with_ec2go_async'] = ['ElectronicAnnotationMethods', 'remap_annotations_with_ec2go']
async_check_methods['ElectronicAnnotationMethods.remap_annotations_with_ec2go_check'] = ['ElectronicAnnotationMethods', 'remap_annotations_with_ec2go']
sync_methods['ElectronicAnnotationMethods.remap_annotations_with_ec2go'] = True
async_run_methods['ElectronicAnnotationMethods.remap_annotations_with_uniprotkb_keyword2go_async'] = ['ElectronicAnnotationMethods', 'remap_annotations_with_uniprotkb_keyword2go']
async_check_methods['ElectronicAnnotationMethods.remap_annotations_with_uniprotkb_keyword2go_check'] = ['ElectronicAnnotationMethods', 'remap_annotations_with_uniprotkb_keyword2go']
sync_methods['ElectronicAnnotationMethods.remap_annotations_with_uniprotkb_keyword2go'] = True
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'ElectronicAnnotationMethods'
        ...
        self.rpc_service.add(impl_ElectronicAnnotationMethods.remap_annotations_with_interpro2go,
                             name='ElectronicAnnotationMethods.remap_annotations_with_interpro2go',
                             types=[dict])
        self.method_authentication['ElectronicAnnotationMethods.remap_annotations_with_interpro2go'] = 'required'
        self.rpc_service.add(impl_ElectronicAnnotationMethods.remap_annotations_with_ec2go,
                             name='ElectronicAnnotationMethods.remap_annotations_with_ec2go',
                             types=[dict])
        self.method_authentication['ElectronicAnnotationMethods.remap_annotations_with_ec2go'] = 'required'
        self.rpc_service.add(impl_ElectronicAnnotationMethods.remap_annotations_with_uniprotkb_keyword2go,
                             name='ElectronicAnnotationMethods.remap_annotations_with_uniprotkb_keyword2go',
                             types=[dict])
        self.method_authentication['ElectronicAnnotationMethods.remap_annotations_with_uniprotkb_keyword2go'] = 'required'
                    ...
                    if auth_req != "none":
                        if token is None and auth_req == 'required':
                            ...
                            err.data = "Authentication required for " + \
                                "ElectronicAnnotationMethods but no authentication header was passed"
                            raise err
